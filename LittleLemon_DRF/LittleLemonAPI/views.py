...
from .serializer import MenuItemSerializer, CategorySerializer, CartSerializer, OrderSerializer, OrderItemSerializer, GroupUserSerializer
...
class GroupView(generics.GenericAPIView):
    ...
    def get(self, request, group_name):
        group_name = group_name.capitalize()  # Ensure the group name is capitalized
...
class SingleGroupView(generics.GenericAPIView):
    queryset = Group.objects.all()
    serializer_class = GroupUserSerializer
    permission_classes = [IsAuthenticated, IsManager]
    throttle_classes = [AnonRateThrottle, UserRateThrottle]
